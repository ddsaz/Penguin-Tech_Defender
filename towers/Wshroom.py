...
class Wshroom(Tower):
    def __init__(self, x: float, y: float, screen_size: tuple, difficulty: str) -> None:
        ...
        self.images = [pygame.transform.scale(pygame.image.load(os.path.join(
                        "assets", "towers", "wizard_shroom", "wizard_shroom.png")).convert_alpha(), (100, 100)),
            pygame.transform.scale(pygame.image.load(os.path.join(
                        "assets", "towers", "wizard_shroom", "wizard_shroom2.png")).convert_alpha(), (100, 100)),
            pygame.transform.scale(pygame.image.load(os.path.join(
                        "assets", "towers", "wizard_shroom", "wizard_shroom3.png")).convert_alpha(), (100, 100)),
            pygame.transform.scale(pygame.image.load(os.path.join(
                        "assets", "towers", "wizard_shroom", "wizard_shroom4.png")).convert_alpha(), (100, 100))]
        self.icon_image = pygame.transform.scale(pygame.image.load(os.path.join(
            "assets", "towers", "wizard_shroom", "icon.png")).convert_alpha(), (80, 80))
        self.image_index = 0
