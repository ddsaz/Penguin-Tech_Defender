...
class SNshroom(Tower):
    def __init__(self, x: float, y: float, screen_size: tuple, difficulty: str) -> None:
        ...
        self.images = [pygame.transform.scale(pygame.image.load(os.path.join(
                            "assets", "towers", "sniper_shroom", "sniper_shroom.png")).convert_alpha(), (90, 90)),
                       pygame.transform.scale(pygame.image.load(os.path.join(
                           "assets", "towers", "sniper_shroom", "sniper_shroom2.png")).convert_alpha(), (90, 90)),
                       pygame.transform.scale(pygame.image.load(os.path.join(
                           "assets", "towers", "sniper_shroom", "sniper_shroom3.png")).convert_alpha(), (90, 90)),
                       pygame.transform.scale(pygame.image.load(os.path.join(
                            "assets", "towers", "sniper_shroom", "sniper_shroom2.png")).convert_alpha(), (90, 90))]
        self.icon_image = pygame.transform.scale(pygame.image.load(os.path.join(
            "assets", "towers", "sniper_shroom", "icon.png")).convert_alpha(), (80, 80))
