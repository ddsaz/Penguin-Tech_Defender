...
class Gshroom_projectile(Projectile):
    def __init__(self, x: float, y: float, target, screen_size: tuple, attack_value: int, attack_type: str) -> None:
        ...
        """Sous-classe du projectile du "Gangsta shroom
        ...
        self.image = pygame.transform.scale(pygame.image.load(os.path.join(
            "assets", "towers", "projectiles", "gshroom_projectile.png")).convert_alpha(), (screen_size[0]/120, screen_size[0]/120))
