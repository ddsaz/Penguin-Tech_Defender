...
class Gshroom(Tower):
    def __init__(self, x: float, y: float, screen_size: tuple, difficulty: str) -> None:
        ...
        self.images = [pygame.transform.scale(pygame.image.load(os.path.join(
                        "assets", "towers", "gangsta_shroom", "gangsta_shroom1.png")).convert_alpha(), (60, 90)),
                       pygame.transform.scale(pygame.image.load(os.path.join(
                        "assets", "towers", "gangsta_shroom", "gangsta_shroom2.png")).convert_alpha(), (60, 90)),
                       pygame.transform.scale(pygame.image.load(os.path.join(
                        "assets", "towers", "gangsta_shroom", "gangsta_shroom3.png")).convert_alpha(), (60, 90)),
                       pygame.transform.scale(pygame.image.load(os.path.join(
                        "assets", "towers", "gangsta_shroom", "gangsta_shroom2.png")).convert_alpha(), (60, 90))]
        self.icon_image = pygame.transform.scale(pygame.image.load(os.path.join(
            "assets", "towers", "gangsta_shroom", "icon.png")).convert_alpha(), (75, 75))
        self.image_index = 0
        ...
        self.range = self.screen_size[0]/4.21
